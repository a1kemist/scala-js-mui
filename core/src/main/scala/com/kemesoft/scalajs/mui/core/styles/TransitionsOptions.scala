...
trait TransitionsOptions extends js.Object {
    ...
    def create: js.UndefOr[js.Function2[String | Array[String], js.UndefOr[CreateTransitionsOptions], String]] = js.native
    def getAutoHeightDuration: js.UndefOr[js.Function1[Double, Double]] = js.native
}

object TransitionsOptions {
    def apply(easing: Option[EasingPartial] = None,
              duration: Option[DurationPartial] = None,
              create: Option[(String | Array[String], Option[CreateTransitionsOptions]) => String] = None,
              getAutoHeightDuration: Option[Double => Double]  = None): TransitionsOptions = {
